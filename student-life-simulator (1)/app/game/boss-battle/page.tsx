...
import { ArrowLeft, Swords, Lock, Trophy, Heart, Zap, Shield } from "lucide-react"
import { BOSSES, type Boss, getBossById } from "@/lib/boss-data"
import { loadGameState, saveGameState, type GameState } from "@/lib/game-state"
import { useGameModal } from "@/lib/use-game-modal"

function BossBattleContent() {
      ...
      >
        ...
        {isUnlocked && !isDefeated && (
          <Button
            ...
            onClick={() => router.push(`/game/boss-battle?boss=${boss.id}`)}
          >
